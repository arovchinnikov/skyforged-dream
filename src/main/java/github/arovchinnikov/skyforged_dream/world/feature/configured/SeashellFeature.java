...
public class SeashellFeature extends Feature<SeashellFeatureConfig> {
    ...
    public SeashellFeature(Codec<SeashellFeatureConfig> configCodec) {
        super(configCodec);
    }

    @Override
    public boolean generate(FeatureContext<SeashellFeatureConfig> context) {
        StructureWorldAccess world = context.getWorld();
        BlockPos pos = context.getOrigin();
        Random random = context.getRandom();
        SeashellFeatureConfig config = context.getConfig();
